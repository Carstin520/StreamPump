...
Current target: code-verified invite-only Pilot candidate on Solana devnet/test-USDC — not deployed production, not live, no real funds. **H0 and H1 human gates are approved; P2 corridor-truth work (`d78815b..e0b6028`) passed an independent Fable 5 review (PASS, 2026-07-12, no blocker/major).** Next gate: **human review node H2**, which is still pending / not approved (see Progress Ledger, 2026-07-12).
