...
Current target: code-verified invite-only Pilot candidate on Solana devnet/test-USDC — not deployed production, not live, no real funds. **P1 Fable review is pending; human review node H1 is closed / not opened until Fable returns PASS** (see Progress Ledger, 2026-07-11).
