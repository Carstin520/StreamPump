...
| --- | --- | --- | --- | --- |
| Note | Ledger interpretation | Each row is a point-in-time snapshot. The newest row supersedes older rows' "current" or "next gate" wording. | Use the newest P6 row for current evidence. | Stop at H6 after the P6 Fable gate. |
