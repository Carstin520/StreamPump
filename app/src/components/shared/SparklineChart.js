...
const SparklineChart = ({ points, width = 140, height = 52, color = "#65ecaf", fillColor = "rgba(101,236,175,0.12)", strokeWidth = 2, className = "", }) => {
    if (!points.length) {
        return null;
    }
    ...
    return (<svg className={className} fill="none" height={height} role="presentation" viewBox={`0 0 ${width} ${height}`} width={width}>
