...
exports.AppLoadingOverlay = void 0;
...
const AppLoadingOverlay = () => {
    ...
    return (<div aria-hidden={!visible} className={`fixed inset-0 z-[100] flex items-center justify-center bg-[#020407] transition duration-500 ${visible ? "pointer-events-auto opacity-100" : "pointer-events-none opacity-0"}`}>
...
exports.AppLoadingOverlay = AppLoadingOverlay;
