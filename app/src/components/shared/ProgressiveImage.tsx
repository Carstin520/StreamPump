...
const shouldUseNativeImage = (src: ImageProps["src"]): src is string => {
  if (typeof src !== "string") {
    return false;
  }

  return src.startsWith("http://") || src.startsWith("https://") || src.startsWith("data:") || isSignedAssetUrl(src);
};
...
export const ProgressiveImage = ({
  ...
  const nativeImageSrc = shouldUseNativeImage(props.src) ? props.src : null;
