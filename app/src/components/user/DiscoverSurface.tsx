...
const ExploreView = () => (
  <div className="space-y-6 py-4">
    <section className="sticky top-16 z-20 bg-[#090d14]/82 pb-1 pt-2 backdrop-blur-xl">
        ...
        {discoverCategories.map((category) => (
          <button
            className={`whitespace-nowrap rounded-full border px-4 py-2.5 transition ${
              category === "推荐"
                ? "liquid-pill border-white/10 bg-white/12 text-white"
    ...
    <section className="liquid-panel flex items-center gap-3 rounded-2xl p-4">
  ...
  >
    <section className="space-y-8 py-6">
      <div className="flex items-end justify-between">
        ...
        <div className="rounded-full bg-[#1d3355]/32 px-4 py-2 text-sm font-medium text-[#7bb6ff]">
          Market Up +4.2%
        </div>
      </div>
