...
For the long-term product target, gap analysis, and page-level `/goal` roadmap, see [docs/streamPump-long-term-roadmap.md](docs/streamPump-long-term-roadmap.md).
