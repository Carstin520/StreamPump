...
最后演示 claim。毕业后，仍持有 eligible S1 position 的粉丝可以领取一笔封顶、非比例的 discovery reward——金额与质押的 SPUMP 多少无关，不是按比例分得的 buyout 份额。确认 claim 之后，claimable balance 清零，代表 discovery reward 发放完成。
